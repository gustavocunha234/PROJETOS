...
// limpar o jogo, declarar o vencedor, atualizar o placar, reiniciar o jogo
...
function computerPlay() {
  ...
  for (let i = 0; i < boxes.length; i++) {
    ...
    // só preencher se estiver vazio o box
    if (boxes[i].childNodes[0] == undefined) {
      if (randomNumber <= 1) {
...
// jogo da velha by Gustavo Cunha Lemos
